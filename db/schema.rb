...
ActiveRecord::Schema.define(version: 2023_04_28_040012) do
  ...
  create_table "user_chats", force: :cascade do |t|
    ...
    t.index ["receiver_id"], name: "index_user_chats_on_receiver_id"
    t.index ["sender_id"], name: "index_user_chats_on_sender_id"
  end
